...
<h1>MODIFIER UNE CATEGORIE :</h1>
    <form action="/projettecweb/include/confirmcategorie.php"enctype="multipart/form-data" method="post" >
            ...
            <div class="input-group">
                ...
                <div class="merge-input-icon">
                    <input type="text" placeholder="Categorie" name="nom" required>
                </div>
            </div>
            <div class="error-alert">
                <?php
                    ...
                    if(isset($_GET['err']))
                    {
                        switch($_GET['err'])
                        {
                            case "ref":echo "reference existe deja"; break;
                            case "nom":echo "la categorie existe deja "; break;
                        }
                    }
        ...
        <div class="login-button">
            <input type="submit" name="MC" value="MODIFIER LA CATEGORIE">
        </div>
