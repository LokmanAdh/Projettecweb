...
<div id="login-card">
    ...
    <form action="/projettecweb/include/confirmclient.php"enctype="multipart/form-data" method="post" >
            ...
            <div class="input-group">
                <label for="pnm">Prenom</label>
                <div class="merge-input-icon">
                    <input type="text" placeholder="prenom" name="pnm" required>
                </div>
            </div>
            ...
            <div class="input-group">
                <label for="tl">Telephone</label>
                <div class="merge-input-icon">
                    <input type="text" placeholder="tel" name="tl" required>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <div class="merge-input-icon">
                    <input type="text" placeholder="addresse" name="addr" required>
                </div>
            </div>
            ...
            if(isset($_GET['err']))
            {
                switch($_GET['err'])
                {
                    case "em":echo "email est deja utilisé"; break;
                    case "tl":echo "tel est deja utilisé"; break;
                }
            }
        ...
        <div class="login-button">
            <input type="submit" name="MC" value="MODIFIER LE CLIENT">
        </div>
    </form>
</div>
