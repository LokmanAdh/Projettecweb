...
<div id="login-card">
        ...
        <form action="/projettecweb/include/confirmproduct.php" enctype="multipart/form-data" method="post" class="login-form" id="login-form">

            <div class="input-group">
                <label for="file">Choisir une image de ce produit :</label>
            ...
            <div class="input-group">
                ...
                <div class="merge-input-icon">
                    <input type="text" placeholder="reference" name="refe" required>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <div class="merge-input-icon">
                    <textarea placeholder="libelle" name="lib" cols=40 rows=5 required></textarea>
                </div> 
            </div>
            ...
            <div class="input-group">
                ...
                <div class="merge-input-icon">
                    <textarea placeholder="description" name="descr" cols=40 rows=5 required></textarea>
                </div> 
            </div>
            ...
            <div class="input-group">
                ...
                <div class="merge-input-icon">
                    <input type="number" placeholder="prix d'achat" name="pa" required>
                </div>
            </div>

            <div class="input-group">
                <label for="pv">Prix unitaire</label>
                <div class="merge-input-icon">
                    <input type="number" placeholder="prix de unitaire" name="pv" required>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <?php foreach($options as $option){?>
                   <option value="<?php echo $option->C_reference ;?>"><?php  echo $option->C_description ;?></option>
                 <?php } ?>
            ...
            <?php
                ...
                if(isset($_GET['err']))
                {
                    switch($_GET['err'])
                    {
                        case "f_type":echo "seulement .jpeg et .jpg sont acceptable"; break;
                        case "too_big":echo "Max 5.0MB"; break;
                        case "dup_ref":echo "Dupplication de référence"; break;
                    }
                }
            ...
            <div class="login-button">
                <input type="submit" name="MP" value="MODIFIER LE PRODUIT">
            </div>
