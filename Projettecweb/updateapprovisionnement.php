...
<head>
    ...
    <title>Update approvisionnement</title>
</head>
<body>
<div>
    <div class="btn">
...
<div id="login-card">
    <h1>Modifier l'approvisionnement</h1>
    <form action="/projettecweb/include/confirmapprovisionnement.php"enctype="multipart/form-data" method="post" >
        ...
        <div class="login-button">
            <input type="submit" name="MA" value="MODIFIER L' APPROVISIONNEMENT">
        </div>
    </form>
</div>
