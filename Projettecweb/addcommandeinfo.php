...
<div id="login-card">
    ...
    <form action="/projettecweb/include/confirmcommandeinfo.php"enctype="multipart/form-data" method="post" >
            ...
            <div class="input-group">
                <label for="stck">Quantite</label>
                <div class="merge-input-icon">
                    <input type="text" placeholder="quantite" name="stck" required>
                </div>
            </div>
        ...
        <div class="error-alert">
            <?php
                ...
                if(isset($_GET['err']))
                {
                    switch($_GET['err'])
                    {
                        case "ref":echo "Produit introuvable"; break;
                        case "stck":echo "Quantite indisponible"; break;
                        case "pr":echo "Produit deja ajouter"; break;
                    }
                }
