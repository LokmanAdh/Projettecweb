...
<form action="gestionclients.php" method='POST'>
    <input type='submit' value='Retourner vers les Client' class='ajout'>
</form>
...
require_once($_SERVER['DOCUMENT_ROOT']."/Projettecweb/include/Class_client.php");
    ...
    $dba = new Dbaccess();
    $dba->query("select * from client where client_email = '".$_POST['em']."'");
    $client = $dba->single2();
    if(empty($client["client_id"])){
        echo "<p class='nfound'>Client introuvable</p>";
    }else{
