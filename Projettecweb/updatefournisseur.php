...
<h1>Ajouter un fournisseur</h1>
    <form action="/projettecweb/include/confirmfournisseur.php"enctype="multipart/form-data" method="post" >
        ...
        <div class="login-button">
            <input type="submit" name="MF" value="MODIFIER LE FOURNISSEUR">
        </div>
    </form>
</div>
<script>
