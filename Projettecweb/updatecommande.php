...
<h1>Modifier la commande </h1>
    <form action="/projettecweb/include/confirmcommande.php"enctype="multipart/form-data" method="post" >
        ...
        <div class="error-alert">
            <?php
                ...
                if(isset($_GET['err']))
                {
                    switch($_GET['err'])
                    {
                        case "em":echo "Client introuvable"; break;
                    }
                }
        ...
        <div class="login-button">
            <input type="submit" name="MC" value="AJOUTER LA COMMANDE">
        </div>
    </form>
</div>
<script>
